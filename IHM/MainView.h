...
#include "models/SceneCarte.hpp"
 ...
 class MainView : public QGraphicsView {
	...
	signals:
		...
		// Signal émis lors du mouvement de la souris (coordonnées scène). 
		void position(QPointF);

	protected:
		//Ajuste la vue lors du redimensionnement de la fenêtre. 
