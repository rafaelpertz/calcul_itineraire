...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ScenePlan_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ScenePlan_t qt_meta_stringdata_ScenePlan = {
    {
QT_MOC_LITERAL(0, 9) // "ScenePlan"
...
const QMetaObject ScenePlan::staticMetaObject = { {
    ...
    qt_meta_stringdata_ScenePlan.offsetsAndSize,
    qt_meta_data_ScenePlan,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ScenePlan_t
, QtPrivate::TypeAndForceComplete<ScenePlan, std::true_type>
